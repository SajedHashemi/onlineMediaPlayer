...
https://github.com/SajedHashemi/pwmWav
- arduinoFFT: To calculate and generate the audio FFT to display the spectrum visualizer on the display
...
** Note: ** To convert an mp4 video file to an mjpeg file, I used the videoConverter.py program, which can be downloaded from this link https://github.com/derdacavga/video-Player/tree/main/videoConverter.